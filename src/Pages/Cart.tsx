    ...
    <div className="cart">
        ...
        <div className="cart__item">
          ...
          <div className="item__info--container">
            <div className="cart__item--amount">
              <button className="item__amount--btn">
                {/* minus svg */}
                <svg
                  width="10"
                  height="10"
      ...
      <div className="cart__bottom">
        ...
        <div className="cart__bottom--buttons ">
          <Link to={`/`} className="cart__bottom--back-btn btn btn--secondary">
            {/* arrow back svg */}
            <svg
              width="8"
              height="14"
          ...
          <button className="cart__bottom--order-btn btn btn--primary">Order now</button>
        </div>
      </div>
    </div>
  );
